...
class UserBase(BaseModel):
    ...
    preferences: Preferences = Field(default_factory=Preferences, alias="preferences")
...
class UserCreate(UserBase):
    password: str = Field(..., alias="password")  # plaintext, sẽ hash ở service
    # cho phép override default từ UserBase nếu cần
...
class UserUpdate(BaseModel):
    ...
    preferences: Optional[Preferences] = Field(None, alias="preferences")
